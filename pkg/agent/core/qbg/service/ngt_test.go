...
func Test_qbg_load(t *testing.T) {
	type args struct {
		ctx  context.Context
		path string
		opts []core.Option
...
func Test_qbg_initNGT(t *testing.T) {
	type args struct {
		opts []core.Option
	}
	type fields struct {
...
func Test_qbg_loadKVS(t *testing.T) {
	type args struct {
		path string
	}
	type fields struct {
...
func Test_qbg_removeInvalidIndex(t *testing.T) {
	type args struct {
		ctx context.Context
	}
	type fields struct {
...
func Test_qbg_moveAndSwitchSavedData(t *testing.T) {
	type args struct {
		ctx context.Context
	}
	type fields struct {
...
func Test_qbg_mktmp(t *testing.T) {
	type fields struct {
		core              core.NGT
		eg                errgroup.Group
		kvs               kvs.BidiMap
...
func Test_qbg_readyForUpdate(t *testing.T) {
	type args struct {
		uuid string
		vec  []float32
	}
