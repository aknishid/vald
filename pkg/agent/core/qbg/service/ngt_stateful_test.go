...
var (
	...
	searchCommand = &commands.ProtoCommand{
		...
		RunFunc: func(
			...
			res, err := qbg.Search([]float32{0.1, 0.1, 0.1}, 3, 0.1, -1.0)
			return &resultContainer{
				err:     err,
				results: res,
			}
	...
	searchByIDACommand = &commands.ProtoCommand{
		...
		RunFunc: func(
			...
			_, res, err := qbg.SearchByID(idA, 3, 0.1, -1.0)
			return &resultContainer{
				err:     err,
				results: res,
			}
	...
	searchByIDBCommand = &commands.ProtoCommand{
		...
		RunFunc: func(
			...
			_, res, err := qbg.SearchByID(idB, 3, 0.1, -1.0)
			return &resultContainer{
				err:     err,
				results: res,
			}
	...
	searchByIDCCommand = &commands.ProtoCommand{
		...
		RunFunc: func(
			...
			_, res, err := qbg.SearchByID(idC, 3, 0.1, -1.0)
			return &resultContainer{
				err:     err,
				results: res,
			}
