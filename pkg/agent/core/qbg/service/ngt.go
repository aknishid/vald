...
import (
	...
	"github.com/vdaas/vald/pkg/agent/core/qbg/model"
...
func (n *qbg) initNGT(opts ...core.Option) (err error) {
	if n.kvs == nil {
...
func (n *qbg) loadKVS(path string) (err error) {
...
func (n *qbg) Search(vec []float32, size uint32, epsilon, radius float32) ([]model.Distance, error) {
	if n.IsIndexing() {
	...
	if err != nil {
		...
		log.Errorf("cgo error detected: qbg api returned error %v", err)
		return nil, err
	}
...
func (n *qbg) SearchByID(uuid string, size uint32, epsilon, radius float32) (vec []float32, dst []model.Distance, err error) {
	if n.IsIndexing() {
...
func (n *qbg) LinearSearch(vec []float32, size uint32) ([]model.Distance, error) {
	if n.IsIndexing() {
		return nil, errors.ErrCreateIndexingIsInProgress
	}
...
func (n *qbg) LinearSearchByID(uuid string, size uint32) (vec []float32, dst []model.Distance, err error) {
	if n.IsIndexing() {
		return nil, nil, errors.ErrCreateIndexingIsInProgress
	}
	vec, err = n.GetObject(uuid)
...
func (n *qbg) CreateIndex(ctx context.Context, poolSize uint32) (err error) {
	ctx, span := trace.StartSpan(ctx, "vald/agent-qbg/service/NGT.CreateIndex")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (n *qbg) SaveIndex(ctx context.Context) (err error) {
	ctx, span := trace.StartSpan(ctx, "vald/agent-qbg/service/NGT.SaveIndex")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (n *qbg) CreateAndSaveIndex(ctx context.Context, poolSize uint32) (err error) {
	ctx, span := trace.StartSpan(ctx, "vald/agent-qbg/service/NGT.CreateAndSaveIndex")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (n *qbg) GetObject(uuid string) (vec []float32, err error) {
