...
func Test_vqueue_IVQLen(t *testing.T) {
	...
	tests := []test{
		func() test {
			...
			return test{
				name: "return 0 when the capacity and leqbgh is 0",
				fields: fields{
					uii: uii,
				},
				want: want{
		...
		func() test {
			...
			return test{
				name: "return 10 when the capacity and leqbgh is 10",
				fields: fields{
					uii: uii,
				},
				want: want{
		...
		func() test {
			...
			return test{
				name: "return 5 when the capacity is 10 and the leqbgh is 5",
				fields: fields{
					uii: uii,
				},
				want: want{
		...
		func() test {
			...
			return test{
				name: "return 7 when the capacity is 10 and the initial leqbgh is 5 but the inserted size is 2",
				fields: fields{
					uii: uii,
				},
				want: want{
