...
type Faiss struct {
	// IndexPath represent the faiss index file path
	IndexPath string `yaml:"index_path" json:"index_path,omitempty"`

	// Dimension represent the faiss index dimension
	...
	// KVSDB represent the faiss bidirectional kv store configuration
