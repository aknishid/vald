...
func (n *qbgMetrics) Register(m metrics.Meter) error {
	...
	return m.RegisterCallback(
		...
		func(ctx context.Context) {
			...
			indexCount.Observe(ctx, int64(n.qbg.Len()))
			uncommittedIndexCount.Observe(ctx, int64(n.qbg.InsertVQueueBufferLen()+n.qbg.DeleteVQueueBufferLen()))
			insertVQueueCount.Observe(ctx, int64(n.qbg.InsertVQueueBufferLen()))
			deleteVQueueCount.Observe(ctx, int64(int64(n.qbg.DeleteVQueueBufferLen())))
			completedCreateIndexTotal.Observe(ctx, int64(n.qbg.NumberOfCreateIndexExecution()))
			executedProactiveGCTotal.Observe(ctx, int64(n.qbg.NumberOfProactiveGCExecution()))
